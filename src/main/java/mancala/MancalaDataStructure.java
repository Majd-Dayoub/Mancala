...
public class MancalaDataStructure implements Serializable {
    ...
    public boolean isLastStoneinStore() {
        if (iteratorPos == PLAYER_ONE || iteratorPos == PLAYER_TWO) {
            return true;
        } else {
            return false;
        }
    ...
    public void setStoppingPoint(int lastPit){
        stoppingPoint = lastPit; 
    }
